...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.onlineaccount.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[onlineaccount.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[onlineaccount.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[onlineaccount.STATUS_REFUSED]]
