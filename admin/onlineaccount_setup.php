...
require_once '../lib/onlineaccount.lib.php';
...
$head = onlineaccountAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104962Name"),
    0,
