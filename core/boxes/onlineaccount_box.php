 ...
 */
class onlineaccountbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "onlineaccount@onlineaccount";
    public $boxlabel;
    public $depends = array("onlineaccount");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/onlineaccount/class/onlineaccount.class.php";
