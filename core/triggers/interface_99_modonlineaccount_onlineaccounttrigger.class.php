...
/**
 * 	\file		core/triggers/interface_99_modMyodule_onlineaccounttrigger.class.php
 * 	\ingroup	onlineaccount
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modOnlineaccount_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfaceonlineaccounttrigger
{
